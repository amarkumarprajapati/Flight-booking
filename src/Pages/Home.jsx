...
const Home = () => {
  ...
  const submitdatanew = async (e) => {
    e.preventDefault();
    try {
      const getalldata = await fetch("http://localhost:2000/api/front", {
        method: "POST",
        headers: {
